...
// Componente responsável pela seção de contato da página
    ...
    <section id="contato" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-700 mt-4">Estamos prontos para atender. Preencha o formulário abaixo e escolha seu canal de preferência para enviar sua mensagem.</p>
        </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-2xl border border-gray-100 flex flex-col justify-between h-full">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold text-lg text-primary-blue">Endereço</h4>
                  <p className="text-gray-600">Rua Domingos De Morais, 2132<br />Vila Mariana, São Paulo - SP</p>
                </div>
              </div>
