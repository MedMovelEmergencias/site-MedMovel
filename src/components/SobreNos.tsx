// Seção "Sobre Nós" - Apresenta empresa, missão e diferenciais
// Contém: imagens de ambulâncias, texto descritivo e cards com vantagens
import React from 'react';
import { ScrollRevealWrapper } from './ScrollRevealWrapper';
import frotaAmbulancias from '../assets/images/frota-ambulancias.jpeg';
import ambulanciaInterno from '../assets/images/ambulancia-interno.jpg';
  ...
  return (
    <section id="sobre" className="py-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-x-8 md:gap-x-12 gap-y-12 md:gap-y-16 items-center">
          <ScrollRevealWrapper variant="fadeInLeft" className="lg:col-span-3 lg:order-1">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-blue dark:text-white">Sobre a Med Móvel</h2>
          ...
          <ScrollRevealWrapper variant="fadeInRight" delay={0.2} className="lg:col-span-2 lg:order-2">
            <img 
              src={frotaAmbulancias} 
              alt="Ambulância da Med Móvel vista de frente"
              className="rounded-lg shadow-2xl w-full h-full object-cover"
            />
          </ScrollRevealWrapper>
          
          <ScrollRevealWrapper variant="fadeInLeft" delay={0.3} className="lg:col-span-3 lg:order-4">
            <h3 className="text-2xl md:text-3xl font-bold text-primary-blue dark:text-white mb-8">Nossos Diferenciais</h3>
            <div className="space-y-6">
              <ScrollRevealWrapper variant="fadeInUp" delay={0.4}>
              ...
              <ScrollRevealWrapper variant="fadeInUp" delay={0.5}>
                <div className="flex items-start">
              ...
              <ScrollRevealWrapper variant="fadeInUp" delay={0.6}>
                <div className="flex items-start">
          ...
          <ScrollRevealWrapper variant="fadeInRight" delay={0.7} className="md:col-span-2 md:order-3">
            <img 
              src={ambulanciaInterno} 
